...
export default function ServicesPage() {
  return (
    <>
      ...
      {/* The full price matrix and the add-on list were repeated here, which
          meant several pages answered "what does it cost" and none of them was
          obviously the place to look. This page says what you get. Pricing
          says what it costs, and is the only page that puts the one-time and
          membership rates side by side. Removed in #60 and reapplied here,
          because this file was branched from before that landed. */}
      <Section tinted>
